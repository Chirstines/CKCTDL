...
public class ControllerView {
	...
	public ArrayList<StudyProgram> getDataFromTable(DefaultTableModel model) {
	    ArrayList<StudyProgram> studyProgramList = new ArrayList<>();
	    for (int i = 0; i < model.getRowCount(); i++) {
	        String programCode = model.getValueAt(i, 0) + "";
	        String programName = model.getValueAt(i, 1) + "";
	        double admissionScore = Double.parseDouble(model.getValueAt(i, 2) + "");
	        ...
	        long tuitionFee = Long.parseLong((String) model.getValueAt(i, 6));
	...
	public StudyProgram getSelectedProgram() {
	    ...
	    double admissionScore = Double.parseDouble(modelTable.getValueAt(rowIndex, 2) + "");
	    ...
	    long tuitionFee = Long.parseLong((String) modelTable.getValueAt(rowIndex, 6));
	    University university = new University(universityCode, universityName, universityAddress);
	...
	public void addToTable() {
		...
		long tuitionFee = Long.parseLong(view.textField_TuitionFee.getText());
		double admissionScore = Double.parseDouble(view.textField_AdmissionScore.getText());
		StudyProgram studyProgram = new StudyProgram(programCode, programName, university, tuitionFee, admissionScore);
